...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".danmaku-containers{\n    position: relative;\n}\n.danmaku-containers  *{\n    box-sizing: border-box;\n    transform-style: preserve-3d;\n    margin: 0;\n    padding: 0;\n    font-size: 40px;\n    image-rendering: pixelated; /* 小图片放大后像素不虚化 */\n    image-rendering: -moz-crisp-edges;\n}\n.danmaku-containers .stage{\n    position: absolute;\n    overflow: hidden;\n    perspective:1000px;\n    transform-style: preserve-3d;\n}\n.danmaku-containers-debug *{\n    outline: 1px solid red;\n}\n\n", "",{"version":3,"sources":["webpack://./src/css/base.css"],"names":[],"mappings":"AAAA;IACI,kBAAkB;AACtB;AACA;IACI,sBAAsB;IACtB,4BAA4B;IAC5B,SAAS;IACT,UAAU;IACV,eAAe;IACf,0BAA0B,EAAE,gBAAgB;IAC5C,iCAAiC;AACrC;AACA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,kBAAkB;IAClB,4BAA4B;AAChC;AACA;IACI,sBAAsB;AAC1B","sourcesContent":[".danmaku-containers{\n    position: relative;\n}\n.danmaku-containers  *{\n    box-sizing: border-box;\n    transform-style: preserve-3d;\n    margin: 0;\n    padding: 0;\n    font-size: 40px;\n    image-rendering: pixelated; /* 小图片放大后像素不虚化 */\n    image-rendering: -moz-crisp-edges;\n}\n.danmaku-containers .stage{\n    position: absolute;\n    overflow: hidden;\n    perspective:1000px;\n    transform-style: preserve-3d;\n}\n.danmaku-containers-debug *{\n    outline: 1px solid red;\n}\n\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _Event_DanmakuEvent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Event/DanmakuEvent */ "./src/ts/Event/DanmakuEvent.ts");
/* harmony import */ var _Event_DanmakuEventType__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Event/DanmakuEventType */ "./src/ts/Event/DanmakuEventType.ts");
...
var Controller = /** @class */ (function () {
    ...
    Controller.prototype.reset = function () {
        ...
        // 触发弹幕舞台重置事件
        _Event_DanmakuEvent__WEBPACK_IMPORTED_MODULE_6__.DanmakuEvent.dispatch(_Event_DanmakuEventType__WEBPACK_IMPORTED_MODULE_7__.DanmakuEventType.DANMAKU_STAGE_RESET, {});
        this.pauseStatus = true;
        this.timeStamp = 0;
        this.time = 0;
        this.skipStatus = false;
    ...
    Controller.prototype.resetDanmaku = function (type) {
        ...
        // 弹幕开始加载事件
        _Event_DanmakuEvent__WEBPACK_IMPORTED_MODULE_6__.DanmakuEvent.dispatch(_Event_DanmakuEventType__WEBPACK_IMPORTED_MODULE_7__.DanmakuEventType.DANMAKU_LOAD_START, {});
        // 获取当前舞台
        ...
        timeline.reset();
        // 根据时间轴类型找到对应的弹幕获取器
        var fun = this.danmakuFunction[stage.timeLineType()];
        // 判断弹幕获取器是否存在
        if (!fun) {
            return;
        }
        fun(function (res) {
            ...
            res.forEach(function (danmakuStr) {
                ...
                // 弹幕加载完成事件
                _Event_DanmakuEvent__WEBPACK_IMPORTED_MODULE_6__.DanmakuEvent.dispatch(_Event_DanmakuEventType__WEBPACK_IMPORTED_MODULE_7__.DanmakuEventType.DANMAKU_LOAD_DONE, {});
            });
        });
    };
    return Controller;
...
/* harmony import */ var _Event_DanmakuEvent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Event/DanmakuEvent */ "./src/ts/Event/DanmakuEvent.ts");
...
var MFADE = /** @class */ (function () {
    ...
    MFADE.prototype.listenerEvent = function (event, callback) {
        _Event_DanmakuEvent__WEBPACK_IMPORTED_MODULE_4__.DanmakuEvent.listener(event, callback);
    };
    return MFADE;
}());
